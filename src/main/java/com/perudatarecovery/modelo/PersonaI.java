...
public class PersonaI {
    ...
    public PersonaI(int id_personai, String tipo_inci, String nombres_c, String apellido_p, String apellido_m, int dni_ce, int edad, String genero, String area_trabajo, String puesto_trabajo, String antiguedad_empleo, String turno, String tipo_contrato, String tiempo_experiencia, int h_trabajadas_antes_inci) {
        this.id_personai = id_personai;
    ...
    public int getId_personai() {
        return id_personai;
    }

    public void setId_personai(int id_personai) {
        this.id_personai = id_personai;
    }
