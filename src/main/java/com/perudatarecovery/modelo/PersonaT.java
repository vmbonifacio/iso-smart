...
public class PersonaT {
    ...
    public PersonaT(int id_personaa_t, String tipo_acci, String nombres_c, String apellido_p, String apellido_m, int dni_ce, int edad, String genero, String empresa_p, String area_trabajo, String puesto_trabajo, String antiguedad_empleo, String turno, int h_trabajadas_antes_acci) {
