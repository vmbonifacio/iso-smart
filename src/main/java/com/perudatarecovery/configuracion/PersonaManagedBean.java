...
public class PersonaManagedBean {
    ...
    public void agregarRegistro() {
        try (
            ...
            System.out.println(selectedPersona.getPuesto_trabajo());
    ...
    public void actualizarPuestos() {
        ...
        if (selectedPersona != null && selectedPersona.getArea_trabajo() != null) {
            ...
            System.out.println(listaPuestos);
        } else {
    ...
    public void onPuestoChange() {
        System.out.println("Nuevo valor de puesto_trabajo: " + selectedPersona.getPuesto_trabajo());
